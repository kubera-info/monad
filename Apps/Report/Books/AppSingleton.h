...
namespace Monad::App
{
	...
	public:
		// Implementation
		void OnThreadDone() noexcept;

		struct TaskHTTPS final : Monad::Threads::ThreadPool::ITask
		{
			TaskHTTPS();
			void Run() final;
		} m_httpsTask;
		...
		Microsoft::WRL::ComPtr<ITaskbarList4> m_taskbarList;
		const uint32_t c_msgTaskbarButtonCreated;
		...
		Repositories::RepositoryGeneric m_repository;
